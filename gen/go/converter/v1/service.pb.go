...
type ConvertPlaylistResponse struct {
	...
	TracksSkipped int32 `protobuf:"varint,8,opt,name=tracks_skipped,json=tracksSkipped,proto3" json:"tracks_skipped,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ConvertPlaylistResponse) GetTracksSkipped() int32 {
	if x != nil {
		return x.TracksSkipped
	}
	return 0
}
...
const file_converter_v1_service_proto_rawDesc = "" +
	...
	"\x16destination_auth_token\x18\x06 \x01(\tR\x14destinationAuthToken\"\x81\x04\n" +
	...
	"\rfailed_tracks\x18\a \x03(\v2\x1c.converter.v1.CanonicalTrackR\ffailedTracks\x12%\n" +
	"\x0etracks_skipped\x18\b \x01(\x05R\rtracksSkipped\"o\n" +
	"\x06Status\x12\x16\n" +
